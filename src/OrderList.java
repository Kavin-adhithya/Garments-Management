...
public class OrderList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			ResultSet rset =sst.executeQuery("select * from Order1") ;
			out.print("<html>");
			out.print("<body>");
			 ...
			 while(rset.next())
			{
					...
					out.print("<td style='height:40px; width:50px; margin:0; padding:10px'>" +rset.getString(9)+"</td>");
					out.print("<td style='height:40px; width:50px; margin:0; padding:10px'>" +rset.getString(10)+"</td>");
					out.print("</tr>");
			 }  
			 out.print("</table");
			 out.print("</body>");
