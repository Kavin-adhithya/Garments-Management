...
public class BuyerList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			ResultSet rset =sst.executeQuery("select * from Buyer") ;
			out.print("<html>");
			out.print("<body>");
			...
			out.print("<th> Buyer Id</th>");
			out.print("<th> Buyer Name</th>");
			out.print("<th> Buyer Contact</th>");
			out.print("<th> Buyer Address</th>");
			out.print("<th> Organization</th>");
			out.print("<th> Cloth Catogory</th>");
			out.print("<th> Units</th>");
